...
<!--                                <h1 class="text-uppercase">Solutions Informatiques</h1>-->
        ...
        <div class="container">
            <div class="text-center mr-3">
                <h2 class="py-4 text-uppercase" style="margin: 20px;"><span class="lettre_color">Services et conseils en informatique</span></h2><hr/>
        ...
        <section>   
            <p class="text-center" id="plus_encore"><span class="h4">Et bien plus encore!</span> <br /> N'hésitez pas à nous contacter par téléphone au <strong class="blue">06 36 48 38 29</strong> ou via <a href="/contact">le formulaire de contact</a></p>
            <div class="mbr-section-btn pt-1" style="text-align: center;"><a class="btn btn-md display-4 btn-services" href="/tarifs">Voir tous les services</a></div>
        </section>
    </article> 
</main>   
