    ...
    <article>
        ...
        <div class="container">
            <div class="text-center mr-3">
                <h2 class="py-4 text-uppercase" style="margin: 20px;"><span class="lettre_color">Services et conseils en informatique</h2><hr/>
        ...
        <section>   
            <p class="text-center" id="plus_encore">Et bien plus encore! <br /> N'hésitez pas à nous contacter par téléphone au <strong style="color: rgb(0, 99, 178);">06 36 48 38 29</strong> ou via <a href="/contact">le formulaire de contact</a></p>
