...
<html lang="fr">
    <head>
        ...
        <meta name="description" content="Solutions informatiques adaptées tout support: unité centrale, PC portable, MAC et PC. Réparation/dépannage à domicile ou en atelier à Aubagne (13).">
            ...
            <div class="row">
                <div class="col-12 no-padding-nav">
                    <nav class="nav navbar navbar-expand-lg navbar-light bg-anthra">  
                        ...
                        <div class="collapse navbar-collapse text-uppercase justify-content-end col-11 col-sm-9 col-md-9 col-lg-8 col-xl-8" id="navbarNavAltMarkup">
    ...
    <script type="text/javascript">
        ...
        console.log(cookieconsent_options)
    </script>
